...
insert into public.role_permissions (role_code, permission_code) values
  ('admin','dashboard.view'),('admin','users.view'),('admin','users.manage'),('admin','clients.view'),('admin','clients.manage'),('admin','cases.view'),('admin','cases.manage'),('admin','documents.view'),('admin','documents.manage'),('admin','tasks.view'),('admin','tasks.manage'),('admin','workflows.manage'),('admin','billing.view'),('admin','billing.manage'),('admin','audit.view'),('admin','reports.view'),('admin','settings.manage'),
  ('supervisor','dashboard.view'),('supervisor','users.view'),('supervisor','clients.view'),('supervisor','clients.manage'),('supervisor','cases.view'),('supervisor','cases.manage'),('supervisor','documents.view'),('supervisor','documents.manage'),('supervisor','tasks.view'),('supervisor','tasks.manage'),('supervisor','workflows.manage'),('supervisor','audit.view'),('supervisor','reports.view'),
