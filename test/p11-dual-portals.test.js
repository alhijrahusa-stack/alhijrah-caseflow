...
const PERSON_A='31111111-1111-4111-8111-111111111111',PERSON_B='32222222-2222-4222-8222-222222222222';
...
beforeEach(()=>{
  ...
  backend.tables.people.push({id:PERSON_A,legal_name:'Person A'},{id:PERSON_B,legal_name:'Person B'});
  backend.tables.case_people.push({case_id:CASE_A,person_id:PERSON_A,case_role:'beneficiary'},{case_id:CASE_B,person_id:PERSON_B,case_role:'beneficiary'});
