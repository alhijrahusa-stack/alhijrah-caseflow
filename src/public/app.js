      ...
      const supplementalUiPhraseArabic=Object.freeze({
        "Sign in with your assigned account. Your session is protected with secure, HTTP-only cookies.":"سجّل الدخول بحسابك المخصص. جلستك محمية بملفات تعريف ارتباط آمنة لا يصل إليها JavaScript.",
